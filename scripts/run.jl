...
m_dubins = Robot.initialize_model(; seed = 1, δt = 0.001, N = 15, com_range = 25., vis_range = 25., history_size = 500, extent=(100.,100.), speed=1.0)
...
Draw.run_simulator!(m_dubins, Robot.agent_laplacian_step!, Robot.initialize_model)
